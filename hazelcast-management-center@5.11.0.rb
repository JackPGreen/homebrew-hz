class HazelcastManagementCenterAT5110 < Formula
    desc "Tool to run Hazelcast Management Center"
    homepage "https://github.com/hazelcast/hazelcast-command-line"
    version "5.11.0"
    url "https://repository.hazelcast.com/download/management-center/hazelcast-management-center-5.11.0.tar.gz"
    sha256 "e9c85da39cad0d7ee6a8c2fc7bebd31c066556c15a9f5ca8f68f40cc85c34137"
    ...
    conflicts_with "hazelcast-management-center@5.9.0", because: "you can install only a single hazelcast-management-center package"
    conflicts_with "hazelcast-management-center@5.8.1.snapshot", because: "you can install only a single hazelcast-management-center package"
    ...
    conflicts_with "hazelcast-management-center@5.10.0", because: "you can install only a single hazelcast-management-center package"
    ...
    conflicts_with "hazelcast-management-center-5.9", because: "you can install only a single hazelcast-management-center package"
